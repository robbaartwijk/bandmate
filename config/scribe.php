...
return [
    ...
    'description' => 'Bandmate API Documentation',
    ...
    'routes' => [
        [
            ...
            'include' => [
                ...
                'acts.index', 'POST /new', '/auth/*',
                'vacancies.index', 'POST /new', '/auth/*',
                'availablemusicians.index', 'POST /new', '/auth/*',
                'rehearsalrooms.index', 'POST /new', '/auth/*',
                'venues.index', 'POST /new', '/auth/*',
                'agencies.index', 'POST /new', '/auth/*'
            ],
