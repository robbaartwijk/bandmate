            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('email-logs.index') }}" style="margin-bottom:15px;">
                    <div style="display:flex; flex-wrap:wrap; gap:8px; align-items:center;">
                        ...
                        <select name="job_id" class="form-control btn btn-secondary btn-round rounded border text-center" style="width:auto; min-width:160px;">
                        ...
                        <select name="status" class="form-control btn btn-secondary btn-round rounded border text-center" style="width:auto; min-width:140px;">
                        ...
                        @if(request('job_id') || request('status'))
                            <a href="{{ route('email-logs.index') }}" class="btn btn-primary">Clear</a>
                        @endif
                ...
                <div class="table-responsive">
                    <table class="table tablesorter">
                        <thead class="text-primary">
                            <tr>
                                <th>Recipient</th>
                                <th class="d-none d-sm-table-cell">Job</th>
                                <th>Status</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-none d-md-table-cell">{{ $log->sent_at ? $log->sent_at->format('d M Y, H:i') : '—' }}</td>
