        ...
        <div class="overflow-x-auto">
            <table class="bm-table">
                ...
                <tbody>
                    ...
                    @php $thumb = $record->getFirstMedia('images/RehearsalroomPics'); @endphp
                    <tr>
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <div class="rounded-full bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0"
                                     style="width:32px; height:32px;">
                                    <i class="fas fa-door-open text-white/25 text-xs"></i>
                                </div>
                                @endif
                                <a href="{{ route('rehearsalrooms.show', $record->id) }}" class="hover:underline">{{ $record->name }}</a>
                            </div>
                        </td>
                        <td>{{ $record->city }}</td>
