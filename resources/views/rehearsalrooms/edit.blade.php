    ...
    <div class="bm-card-body">
        <form action="{{ route('rehearsalrooms.update', $rehearsalroom->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="bm-form-group">
                ...
                <input type="text" id="address" name="address" value="{{ old('address', $rehearsalroom->address) }}" class="bm-input" placeholder="{{ __('rehearsalrooms.address_placeholder') }}">
                @error('address') <span class="bm-error">{{ $message }}</span> @enderror
            </div>
            <div class="bm-form-group">
                <label for="zip" class="bm-label">{{ __('rehearsalrooms.zip') }}</label>
                <input type="text" id="zip" name="zip" value="{{ old('zip', $rehearsalroom->zip) }}" class="bm-input" placeholder="{{ __('rehearsalrooms.zip_placeholder') }}">
