                    ...
                    <div class="float-right">
                        ...
                        <form action="{{ route('genres.index') }}" method="get">
                            <div class="input-group no-border">
                                ...
                                <select name="sort" class="form-control btn btn-secondary btn-round rounded border text-center" style="margin: 10px; width: 210px;" onchange="location.href='{{ route('genres.index') }}?sort=' + this.value + '&search=' + document.querySelector('input[name=search]').value">
