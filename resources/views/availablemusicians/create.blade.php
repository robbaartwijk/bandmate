...
@section('content')
<div class="bm-card">
    <div class="bm-card-header"><h2 class="bm-card-title">Add available musician listing</h2></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-4">
                    ...
                    <div class="bm-form-group">
                        ...
                        <input type="hidden" name="user_id" value="{{ $availablemusician->user->id }}">
                    </div>
                ...
                <div class="bm-form-group">
                    ...
                    <textarea id="description" name="description"
                              class="bm-textarea h-48 @error('description') border-red-500 @enderror"
                              placeholder="Describe yourself as a musician...">{{ old('description') }}</textarea>
                    @include('alerts.feedback', ['field' => 'description'])
                </div>
            </div>

            <div class="flex items-center gap-3 mt-4 pt-4 border-t border-white/10">
                <button type="submit" class="bm-btn bm-btn-primary"><i class="fas fa-plus"></i> Add listing</button>
