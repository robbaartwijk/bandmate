        ...
        <div class="bm_card card">
            ...
            <div class="card-body">
                ...
                @can('create', \App\Models\EmailJob::class)
                    <a href="{{ route('email-jobs.create') }}" class="btn btn-primary">New job</a>
                @endcan
                ...
                <table class="table tablesorter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $job->recipients_count ?? $job->recipients()->count() }}</td>
                            <td>{{ $job->scheduled_at ? $job->scheduled_at->format('d M Y, H:i') : 'Immediate' }}</td>
